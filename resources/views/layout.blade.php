                    ...
                    <div class="col-sm-6">
                        <div class="contactinfo">
                            <ul class="nav nav-pills">
                                <li><a href="#"><i class="fa fa-envelope"></i> teamOne@gmail.com</a></li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-sm-6">
                    ...
                    <div id="slider-carousel" class="carousel slide" data-ride="carousel">
                        ...
                        @foreach($slider as $key => $slide)
                            ...
                            <div class="item {{$i==1 ? 'active' : '' }}">
                                ...
                                <div class="col-sm-12">
                                    <img alt="{{$slide->slider_desc}}" src="{{asset('public/uploads/slider/'.$slide->slider_image)}}" style="height: 400px; width:100%" class="img img-responsive">
