...
<body>
    <section id="container">
        ...
        <header class="header fixed-top clearfix">
            ...
            <!--logo end-->
            <!--noti, deadline fake start-->
            <!-- @ yield('notianddeadline') -->
            <!--noti, deadline fake end-->
                ...
                <ul class="nav pull-right top-menu">
                    ...
                    <li class="dropdown">
                        <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                            <img alt="" src="{{asset('frontend/admin/images/avatar.jpg')}}">
            ...
            <div id="sidebar" class="nav-collapse">
                ...
                <div class="leftside-navigation">
                    <ul class="sidebar-menu" id="nav-accordion">
                        <li>
                            <a class="active" href="{{URL::to('/admin/tongquan')}}">
                        ...
                        <li class="sub-menu">
                            ...
                            <ul class="sub">
                                <li><a href="{{URL::to('/admin/themcategory')}}">Thêm danh mục</a></li>
                                <li><a href="{{URL::to('/admin/lietkecategory')}}">Liệt kê danh mục</a></li>
                            </ul>
                        </li>
                        <li class="sub-menu">
                            <a href="javascript:;">
                            ...
                            <ul class="sub">
                                <li><a href="{{URL::to('/admin/thembrand')}}">Thêm thương hiệu</a></li>
                                <li><a href="{{URL::to('/admin/lietkebrand')}}">Liệt kê thương hiệu</a></li>
                            </ul>
                        </li>
                        <li class="sub-menu">
                            <a href="javascript:;">
                            ...
                            <ul class="sub">
                                <li><a href="{{URL::to('/admin/themproduct')}}">Thêm sản phẩm</a></li>
                                <li><a href="{{URL::to('/admin/lietkeproduct')}}">Liệt kê sản phẩm</a></li>
                            </ul>
                        </li>
                    </ul>
                </div>
        ...
        <section id="main-content">
            <section class="wrapper">
                <!-- //market-->
                <!-- xóa khoảng trắng để gọi lại @  yield('marketupdate') -->
                <!-- //market-->

                <!-- @ yield('vistiorsdiagram') -->
                @yield('admin_content')
